...
export default class News extends Component {
    ...
    async componentDidMount(){
        let url= "https://newsapi.org/v2/everything?q=india&apiKey=629c256e8600416e9087fb1b1f8a8206&page=1&pageSize=20";
     ...
     handlePreviousClick=async()=>{
        ...
        let url= `https://newsapi.org/v2/everything?q=india&apiKey=629c256e8600416e9087fb1b1f8a8206&page=${this.state.page - 1}&pageSize=20`;
                let data= await fetch(url);
                let parsedData= await data.json()
                console.log(parsedData);
                this.setState({
